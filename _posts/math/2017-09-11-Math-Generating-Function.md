...
$$\binom{0pear \quad 1pear}{x^0 \quad + \quad x^1} \cdot \binom{0apple \quad 1apple}{x^0 + x^1} \cdot \binom{0orange \quad 1orange}{x^0 + x^1} \cdot \binom{0banana \quad 1banana}{x^0 + x^1} \cdot \binom{0papaya \quad 1papaya}{x^0 + x^1}$$
