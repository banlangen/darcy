...
$$\binom{0pear or 1pear}{x^0 + x^1} \cdot \binom{0apple or 1apple}{x^0 + x^1} \cdot \binom{0orange 或 1orange}{x^0 + x^1} \cdot \binom{0banana or 1banana}{x^0 + x^1} \cdot \binom{0papaya 或 1papaya}{x^0 +x^1}$$
